<template>
	<div :style="{background: backgroundColor}">
		...
		<beautiful-chat :participants="participants" :titleImageUrl="titleImageUrl" :onMessageWasSent="onMessageWasSent"
			...
			:open="openChat" :showEmoji="true" :showFile="true" :showTypingIndicator="showTypingIndicator"
		...
		<v-dialog />
		<p class="text-center messageStyling"><label>Message styling enabled? <input type="checkbox"
					@change="messageStylingToggled" checked></label><a href="#"
				@click.prevent="showStylingInfo()">info</a></p>
