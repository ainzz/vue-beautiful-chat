...
<script>
	...
	export default {
		...
		props: {
			...
			noMessagesText: {
				type: String,
				default: 'Nu exista conversatii. Poti incepe una chiar acum!'
			}
		},
		methods: {
			_scrollDown() {
			...
			shouldScrollToBottom() {
				return this.alwaysScrollToBottom || (this.$refs.scrollList.scrollTop > this.$refs.scrollList.scrollHeight -
					600)
			},
			profile(author) {
